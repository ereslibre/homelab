(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window ack adoc-mode browse-kill-ring carbon-now-sh company dockerfile-mode doom-themes dumb-jump elm-mode git-link go-mode google-translate haskell-mode helm helm-company helm-lsp helm-project just-mode json-mode lsp-mode magit markdown-mode monokai-theme nix-mode org-journal perfect-margin powerline rainbow-delimiters ripgrep rust-mode terraform-mode undo-tree use-package writeroom-mode yaml-mode yasnippet zig-mode))
